function milusidebar(setting) {
    var c = {
        names: "麋鹿鲁哟",
        notice:
            '<b>温馨提示</b><span><a href="https://github.com/miluluyo/cute-cnblogs" target="_black">cute-cnblogs</a> &nbsp;样式已开源</span>' +
            '<b style="margin-top: 3px;"><a style="font-size:10px" href="https://www.cnblogs.com/IsAlpaca/" target="_black">查看一期样式</a></b>',
        headerUrl:
        ...
        popper_weixin:
            ...
            '<p><b>很高兴认识你鸭~  (づ｡◕ᴗᴗ◕｡)づ</b></p>' +
            '<div class="popper_box_con">' +
            '<div class="popper_box_con_li"><img src="https://images.cnblogs.com/cnblogs_com/miluluyo/1765646/o_200614064005qrcode.jpg" alt="">公众号：麋鹿鲁哟</div>' +
            '<div class="popper_box_con_li"><img src="https://images.cnblogs.com/cnblogs_com/miluluyo/1493340/t_wxh.jpg" alt="">微信号：s978761</div>' +
            '</div><p>（加我记得备注博客园喔）</p></div>',
        portrait:
...
function sidebar(c) {
    ...
    $("#sidebar_news .catListTitle").before(
        ...
        '<p class="notice_title">' + c.notice + "</p></div>"
    );
    ...
    var sidebarInfoHtml =
        '<p class="catListTitle" style="font-weight:500;margin-top:10px;">' + c.names + '</p><table id="info_table" style="">';
    ...
    for (var i = 0; i < le; i++) {
        ...
        for (var j = 0; j < sidebarInfo[i].length; j++) {
            ...
            if (item.click == false) {
                ...
                sidebarInfoHtml += '<td><a href="' + item.url + '" target="_black" title="' + item.title + '">' + node + '</a></td>';
            }
        }
        sidebarInfoHtml += "</tr>";
    }
